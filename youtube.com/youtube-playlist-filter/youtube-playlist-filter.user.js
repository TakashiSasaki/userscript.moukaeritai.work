    function createPanel() {
        if (document.getElementById('youtube-playlist-filter-panel')) return;

        const panel = document.createElement('div');
        panel.id = 'youtube-playlist-filter-panel';
        ...
        titleLabel.textContent = 'Youtube Playlist Filter';
        ...
        contentDiv.id = 'youtube-playlist-filter-panel-content';
        ...
        window.youtubeSetupDraggablePanel(panel, headerRow, 'youtube-playlist-filter_panel_position');
        window.youtubeSetupMinimizablePanel(panel, 'youtube-playlist-filter_is_minimized', false);
    }

    function updatePanelVisibility() {
        const panel = document.getElementById('youtube-playlist-filter-panel');
        if (!panel) return;

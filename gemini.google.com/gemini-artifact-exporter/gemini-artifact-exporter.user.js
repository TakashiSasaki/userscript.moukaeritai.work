...
// @version      0.2.14
// @description  Adds a persistent floating UI to scan and export all artifact blocks from a Gemini conversation as files.
...
// @noframes
// @history      0.2.14 共通テンプレート更新に伴う同期修正: ヘッダー表示を [絵文字][スクリプト名]v[バージョン] 形式に変更し、シングルクリック開閉に対応。

...
def preprocess_html(file_path):
    ...
    # Remove Angular attributes starting with _ngcontent
    print("Removing Angular internal attributes...")
    for tag in soup.find_all(True):
        attrs_to_remove = [k for k in tag.attrs.keys() if k.startswith('_ngcontent')]
    ...
    # Prettify to make it readable again after collapsing

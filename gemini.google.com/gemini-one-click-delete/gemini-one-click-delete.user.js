...
// @grant        GM_addStyle
// @noframes
// @history      0.3.27 共通テンプレート更新に伴う同期修正: ヘッダー表示を [絵文字][スクリプト名]v[バージョン] 形式に変更し、シングルクリック開閉に対応。
// @history      0.3.26 UI共通化: パネルの外枠を gemini-common.html に統合し、ダブルクリックで開閉するように変更。ポータルアイコン(🗑️ + ロード順絵文字)を採用。

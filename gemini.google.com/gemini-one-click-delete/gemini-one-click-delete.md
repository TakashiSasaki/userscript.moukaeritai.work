...
*   **有効化**: チャットページ (`/app/...` または `/gem/...` ) に遷移した際に、削除ボタンやショートカット機能が自動的に有効になります。
...
## 更新履歴
*   **v0.1.18**: SPA対応強化に伴う内部変更。本バージョンが0.1.x系列の最終版となります。今後の開発は0.2.0から開始します。
*   **v0.1.17**: `/gem/`から始まるURL形式のチャットページにも対応。

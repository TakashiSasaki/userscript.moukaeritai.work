...
- [共有ダイアログ内の 'Export to Docs' ボタン](#共有ダイアログ内の-export-to-docs-ボタン)
- [エクスポート先選択内の 'Export to Docs' 決定ボタン](#エクスポート先選択内の-export-to-docs-決定ボタン)
- [各メッセージの『その他のオプション』ボタン（三点リーダー）](#各メッセージのその他のオプションボタン三点リーダー)
- [オプションメニュー内の 'Export to...' 項目](#オプションメニュー内の-export-to-項目)
...
## 共有ダイアログ内の 'Export to Docs' ボタンのセレクタ
...
# エクスポート先選択内の 'Export to Docs' 決定ボタン
このボタンはExport toボタンを押した後に表示される。
ボタンの表面には Export to Docs と表示されている。

## エクスポート先選択内の 'Export to Docs' 決定ボタンのHTML断片
...
## エクスポート先選択内の 'Export to Docs' 決定ボタンのセレクタ
```CSS
#cdk-dialog-3 > actions-bottom-sheet > div > div.options.ng-star-inserted > div > button:nth-child(1)
```

# 各メッセージの『その他のオプション』ボタン（三点リーダー）

## 各メッセージの『その他のオプション』ボタン（三点リーダー）のHTML断片
...
## 各メッセージの『その他のオプション』ボタン（三点リーダー）のセレクタ
...
# オプションメニュー内の 'Export to...' 項目

## オプションメニュー内の 'Export to...' 項目のHTML断片
...
# 詳細（キャンバス）を開く 'Open' ボタン

## 詳細（キャンバス）を開く 'Open' ボタンのHTML断片
